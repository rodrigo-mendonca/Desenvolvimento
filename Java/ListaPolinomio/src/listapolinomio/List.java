...
public class List {
	 ...
	 */
        public List Add(double[]... toValores){		
            
            for(double[] oL : toValores)
            {
                Add(oL);
            }
            return(this);
	...
	public List Add(double[] toValor){		
            Node oAux = oRaiz;
	 ...
	 */
	public List Add(int tnPos, double[] toValor){
	 ...
	 */
	public boolean Contains(double[] toValor){
            Node oAux = oRaiz;		
            while(oAux.getProx() != null){
	 ...
	 */
	public boolean Remove(double[] toValor){		
	    Node oAux = oRaiz;		
            while(oAux.getProx() != null){
                if(oAux.getProx().getDado().equals(toValor)){
